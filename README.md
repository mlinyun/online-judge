# LYOJ (LingYun Online Judge) - 从零开始打造 Online Judge
...
本项目已正式更名为 **LYOJ (LingYun Online Judge)**，并新增了全新的 **Cyberpunk 风格后台管理系统**。

### 后台管理系统特性

- **仪表盘**: 实时监控系统状态、提交统计和最新动态。
- **题目管理**: 题库的增删改查，支持难度分级和标签管理。
- **用户管理**: 用户权限控制、封禁/解封操作。
- **公告管理**: 系统公告的发布与维护。
- **内容审核**: 题解、讨论和评论的审核与管理。
- **现代化 UI**: 采用 Tailwind CSS 构建的响应式界面，深色玻璃拟态风格。
