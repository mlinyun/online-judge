 ...
 * - 存储键的统一管理和规范
 *
 * 存储键格式：oj-v{version}-{storeId}
 * 例如：oj-v1.0.0-user, oj-v1.0.0-setting
 *
...
export class StorageConfig {
    ...
    /** 存储键前缀 */
    static readonly STORAGE_PREFIX = "oj-v";

    /** 版本键名 */
    static readonly VERSION_KEY = "oj-version";

    /** 主题键名（index.html中使用了，如果修改，需要同步修改） */
    static readonly THEME_KEY = "oj-theme";

    /** 上次登录用户ID键名（用于判断是否为同一用户登录） */
    static readonly LAST_USER_ID_KEY = "oj-last-user-id";
